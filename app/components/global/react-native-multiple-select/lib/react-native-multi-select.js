...
export default class MultiSelect extends Component {
  ...
  static defaultProps = {
    ...
    selectedItems: [],
    uniqueKey: '_id',
    tagBorderColor: colorPack.danger,
    tagTextColor: colorPack.danger,
    fontFamily: '',
    tagRemoveIconColor: colorPack.danger,
    selectedItemFontFamily: '',
    selectedItemTextColor: colorPack.secondary,
    searchIcon: defaultSearchIcon,
    itemFontFamily: '',
    itemTextColor: colorPack.textSecondary,
    itemFontSize: 16,
    selectedItemIconColor: colorPack.secondary,
    searchInputPlaceholderText: 'Search',
    searchInputStyle: { color: colorPack.secondary, paddingTop:10, paddingBottom:10, margin:5 },
    textColor: colorPack.textPrimary,
    selectText: 'Select',
    altFontFamily: '',
    hideSubmitButton: false,
    submitButtonColor: '#018D36',
